...
public abstract class BaseController extends Controller {
	...
	protected void setCurDateToQueryParam(String FieldName,String pattern){
		String mon = (String) splitPage.getQueryParam().get(FieldName);
		if (StringUtils.isEmpty(mon)) {
			String current = ToolDateTime.getCurrent(pattern);
			splitPage.getQueryParam().put(FieldName, current);
		}
	}
	/**
	 * 设置日志描述
